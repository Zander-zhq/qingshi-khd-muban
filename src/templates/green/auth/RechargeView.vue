...
import { useRechargePage } from '../../../composables/useRechargePage'

const {
  router, activeTab, acctno, cardKey, loading, errMsg, successMsg,
  clearMsg, switchTab, handleRecharge, handleStartPay,
  ...
  formatPrice, formatDuration, selectPackage,
  closeQrModal,
} = useRechargePage()
</script>
